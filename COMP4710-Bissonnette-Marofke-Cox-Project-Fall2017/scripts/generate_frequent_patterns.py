...
# These values are dependent on the specific training data input. Specifically, change the YEAR interval and NOMINAL interval as appropriate for different inputs
